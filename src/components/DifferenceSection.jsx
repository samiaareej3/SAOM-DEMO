...
export default function DifferenceSection() {
  ...
  useEffect(() => {
    Object.entries(WORD_DEPTH).forEach(
      ([id, depth]) => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const marks =
        patternMarkRefs.current.filter(Boolean)
      ...
      if (prefersReducedMotion) {
        ...
        gsap.set(
          backtrackLabelsRef.current.filter(Boolean),
          {
            autoAlpha: 1,
            x: 0,
          }
        ...
        gsap.set(
          routeNodesRef.current.filter(Boolean),
          {
            autoAlpha: 1,
            scale: 1,
          }
        ...
        gsap.set(
          routeLabelsRef.current.filter(Boolean),
          {
            autoAlpha: 1,
            y: 0,
          }
  ...
  useEffect(() => {
    ...
    Object.keys(WORD_DEPTH).forEach(
      (id) => {
        const el =
          wordRefs.current[id]
      ...
      >
        ...
        >
                    ...
                    {PATTERN_LETTERS.map(
                      (ch, i) => (
                        ...
                        >
                          ...
                          {i <
                            PATTERN_LETTERS.length -
                              1 && (
                            <span
                              ref={(el) =>
                                el &&
                                (patternMarkRefs.current[
                                  i
                                ] = el)
                              }
                              aria-hidden="true"
          ...
          <div
            ...
            style={{
              ...
              opacity: 0,
              background:
                `linear-gradient(90deg, transparent, ${RED}18, transparent)`,
            }}
          />
        ...
        >
          ...
          <p
            ...
            "
          >
            SAOM AI traces the event backward —
            location by location — until the origin
            becomes visible.
          </p>
