...
const LABEL_SIDE_CLASS = {
  right:
    'absolute left-full ml-2 top-1/2 -translate-y-1/2 text-left',

  left:
    'absolute right-full mr-2 top-1/2 -translate-y-1/2 text-right',

  top:
    'absolute bottom-full mb-2 left-1/2 -translate-x-1/2 text-center',

  bottom:
    'absolute top-full mt-2 left-1/2 -translate-x-1/2 text-center',
}
...
export default function PinnedStory() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const signalNodes = Object.values(
        signalNodeRefs.current
      )

      const attackNodes = Object.values(
        attackNodeRefs.current
      )
      ...
      gsap.set(progressRefs.current[0], {
        backgroundColor: RED,
      })

      gsap.set(signalNodes, {
        autoAlpha: 0,
        y: 8,
        scale: 0.85,
        filter: 'blur(6px)',
      ...
      gsap.set(gaugeCircleRef.current, {
      ...
      gsap.set(responsePanelRef.current, {
        autoAlpha: 0,
        y: 32,
      })
      ...
      REVEAL_SEQUENCE.forEach((ids, i) => {
        const targets = ids
          .map(
            (id) =>
              signalNodeRefs.current[id] ||
              attackNodeRefs.current[id]
          )
          .filter(Boolean)
    ...
    <>
        ...
        {SIGNAL_EVENTS.map((ev) => {
          ...
          return (
            <motion.div
              ...
              ref={(el) => {
                if (el) {
                  signalNodeRefs.current[ev.id] = el
                }
              }}
              ...
              <span className="pinned-story-visual inline-block transition-opacity duration-300">
                ...
                <span
                  className={`pinned-story-pulse block rounded-full ${
                    isTier2
                      ? 'h-[6px] w-[6px] bg-paper/70'
                      : 'h-[4px] w-[4px] bg-paper/35'
                  }`}
                  style={{
                    animationDuration: isTier2
                      ? '4s'
                      : '5.5s',
                  }}
                />
                ...
                <span
                  className={`${LABEL_SIDE_CLASS[ev.side]} whitespace-nowrap`}
                >
                  <span
                    className={`font-mono-tech block text-[9px] transition-colors duration-300 ${
                      isTier2
                        ? 'text-paper/60 group-hover:text-signal'
                        : 'text-paper/0 group-hover:text-paper/70'
                    }`}
                  >
                    {ev.label}
                  </span>
      ...
      {ATTACK_NODES.map((node) => (
        <motion.div
          ...
          ref={(el) => {
            if (el) {
              attackNodeRefs.current[node.id] = el
            }
          }}
          className="group absolute -translate-x-1/2 -translate-y-1/2"
          style={{
      ...
      <div
        ref={understandLabelsRef}
        className="absolute right-0 top-0 w-[168px] text-right"
      >

        <p className="font-mono-tech text-[10px] text-paper/50">
          threat confidence
        </p>

        <svg
          viewBox="0 0 100 100"
          className="mx-auto mt-2 h-24 w-24 -rotate-90"
          aria-hidden="true"
        >
          <circle
            cx="50"
        ...
        <p
          ref={gaugeTextRef}
          className="font-mono-tech -mt-16 text-lg text-paper"
        >
          87%
        </p>
      ...
      <ol
        ref={timelineListRef}
        className="absolute bottom-0 left-0 flex flex-col gap-2"
      >
        {ATTACK_NODES.map((node) => (
          <li
            key={`tl-${node.id}`}
            className="font-mono-tech flex items-baseline gap-3 text-[11px]"
          >
  ...
  const responseContent = (
    <>
      <div>
        <p className="font-mono-tech text-xs text-paper/50">
          incident understood
        </p>

        <p className="font-mono-tech text-xs text-signal">
          high confidence
        </p>
      </div>
      ...
      <p className="max-w-xs text-sm leading-relaxed text-paper/60">
        SAOM AI proposes. Your team approves.
      </p>
    </>
  )
    ...
    >
      ...
      <style>{`
        ...
        .live-investigation {
          ...
          animation:
            live-investigation-enter
            1s cubic-bezier(0.22, 1, 0.36, 1)
            0.15s forwards;
        }

        @keyframes live-investigation-enter {
        ...
        .live-investigation-text {
          ...
          animation:
            live-investigation-pulse
            4s ease-in-out
            1.1s infinite;
        }

        @keyframes live-investigation-pulse {
      ...
      <h2 className="sr-only">
        SAOM AI detects a signal, investigates the
        connections, understands the attack, and responds.
      </h2>
      ...
      >
        ...
        <div className="order-2 w-full md:order-2 md:w-[42%]">
          ...
          <div className="live-investigation mb-10">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="live-investigation-text font-sans text-[23px] font-extrabold uppercase leading-none md:text-[29px]">
                Live Investigation
              </p>
          ...
          {prefersReducedMotion ? (
            ...
            <div className="flex flex-col gap-10">
              ...
              {STAGES.map((s, i) => (
                <div key={i}>
                  ...
                  <p className="font-mono-tech mb-4 text-xs font-medium uppercase tracking-[0.18em] text-signal">
                    {s.tag}
                  </p>

                  <h3 className="story-stage-title text-3xl font-bold leading-[0.95] md:text-4xl">
                    {s.title}
                  </h3>

                  <p className="story-stage-body mt-5 text-base leading-relaxed text-paper/65 md:text-lg">
                    {s.body}
                  </p>
            ...
            <div className="relative h-[270px] max-w-lg md:h-[250px]">
              ...
              {STAGES.map((s, i) => (
                ...
                >
                  ...
                  <p className="font-mono-tech mb-5 text-xs font-medium uppercase tracking-[0.18em] text-signal">
                    {s.tag}
                  </p>

                  <h3 className="story-stage-title text-3xl font-bold leading-[0.95] md:text-5xl">
                    {s.title}
                  </h3>

                  <p className="story-stage-body mt-6 text-base leading-[1.6] text-paper/65 md:text-lg">
                    {s.body}
                  </p>
          ...
          <div className="mt-8 flex gap-2">
            ...
            {STAGES.map((_, i) => (
              ...
              <span
                ...
                className="h-[2px] w-10 bg-[#3a3a38] transition-colors"
              />
        ...
        {prefersReducedMotion ? (
          ...
          <div className="order-1 flex w-full flex-col gap-8 md:order-1 md:w-[58%]">
            ...
            <div
              className="pinned-story-canvas relative mx-auto aspect-[4/3] w-full max-w-xl"
              style={{
                perspective: '1400px',
              }}
            >
          ...
          <div
            className="order-1 pinned-story-canvas relative w-full md:order-1 md:w-[58%]"
            style={{
              perspective: '1400px',
            }}
          >
            ...
            >
              ...
              <div
                ...
                className="absolute inset-0 flex flex-col justify-center gap-6 bg-ink"
              >
                {responseContent}
              </div>
